...
Pod::Spec.new do |s|
  s.name             = 'WolfLocation'
  s.version          = '0.1.0'
  s.summary          = 'A short description of WolfLocation.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ironwolf/WolfLocation'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ironwolf' => 'wolf@wolfmcnally.com' }
  s.source           = { :git => 'https://github.com/ironwolf/WolfLocation.git', :tag => s.version.to_s }
